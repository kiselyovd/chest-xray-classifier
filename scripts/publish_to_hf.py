...
def main() -> None:
    ...
    parser.add_argument("--base-model", default="", help="HF base model ID (e.g. facebook/convnextv2-tiny-22k-224).")
    ...
    parser.add_argument("--domain-tag", default="", help="Domain tag (e.g. medical-imaging).")
    parser.add_argument("--pipeline-tag", default="", help="HF pipeline tag (e.g. image-classification).")
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        render_model_card(
            ...
            model_description="Production-grade 3-class chest X-ray classifier: normal vs bacterial pneumonia vs viral pneumonia.",
